...
Wechat.prototype.registerUser = function(info){
...
Wechat.prototype.getUserById = function(id){return this.users[id];};
Wechat.prototype.getUserByUsername = function(username){return this.usernameUsers[username];};
Wechat.prototype.createClient = function(config){return new WechatClient(this, config);};
Wechat.prototype.registerSite = function(info){
    ...
    site._setQrcode(this._nextId('site-client'));
...
Wechat.prototype.getSiteById = function(id){return this.sites[id];};
Wechat.prototype.getSiteByCode = function(code){return this.codeSites[code];};
Wechat.prototype.getSiteByQrcode = function(qrcode){return this.qrcodeSites[qrcode];};


Wechat.prototype._nextId = function(key){
    if(!this._ids[key]){
        this._ids[key] = 0;
    }
