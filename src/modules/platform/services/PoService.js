...
/**
 * Create an platform operator from openid
 * @param openid
 * @param callback
 */
Service.createFromOpenid = function(openid, callback){
    ...
    co(function*(){
        try{
            ...
            console.error('OperatorService createFromOpenId err:' + err);
...
/**
 * Set user role to platform operator role by openid
 * @param openid
 * @param callback
 */
Service.setRoleByOpenid = function(openid, callback){
    co(function*(){
        ...
        try{
            ...
            logger.error('OperatorService setRoleByOpenid err:' + err);
            if(callback) callback(err, null);
        }
    });
};
