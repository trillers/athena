 ...
 *      FromUserName: botid (bucketid:openid)
 *      MsgType: 'image'
 *      MediaId: to-be-sent media id which is generated by us, not wechat
 *      Url: file path of the image which is stored in our server
 *  }
 */
WechatBotManager.prototype.sendImage = function(botInfo, msg){
    var botid = typeof botInfo == 'string' ? botInfo : this._encodeBotid(botInfo);
    msg.MsgType = 'image';
    msg.FromUserName = botid;
    this.proxy.send(msg);
